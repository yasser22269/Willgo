        ...
        <div class="change-plan-wrapper align-items-center">
            <div class="plan-item">
                <div class="plan-header">
                    <img class="plan-header-shape" src="{{ dynamicAsset('/public/assets/admin/img/plan-1.svg') }}" alt="">
            ...
            <div class="plan-seperator-arrow mx-auto">
                <img src="{{ dynamicAsset('/public/assets/admin/img/arrow.svg') }}" alt="" class="w-100">
            </div>
            <!-- Plan Seperator Arrow -->
            ...
            <div class="plan-item">
                <div class="plan-header">
                    ...
                    <img class="plan-header-shape" src="{{ dynamicAsset('/public/assets/admin/img/plan-2.svg') }}" alt="">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <label class="payment__method">
                <input type="radio" name="payment_type" value="pay_now"  {{ $digital_payment == 1 ? 'checked'  : 'disabled' }}   hidden="">
                <div class="payment__method-card {{ $digital_payment != 1 ?  'payment-warning' : ' ' }} ">
        ...
        <div class="col-md-6">
            <label class="payment__method">
                <input type="radio"  name="payment_type" value="wallet" {{ $digital_payment != 1 ? 'checked'  : '' }}   hidden="">
