...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.Password_recovery') }} | {{$app_name??translate('Willgoapp')}}</title>
    ...
    <main id="content" role="main" class="main auth-bg">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            <div class="auth-content">
                <div class="content">
                    <h2 class="title text-uppercase">{{translate('messages.welcome_to_app')}} {{ $app_name??'Willgoapp' }}</h2>
                    <p>
            ...
            <div class="auth-wrapper">
                <div class="auth-wrapper-body auth-form-appear">
                    ...
                    <a class="auth-logo mb-5" href="javascript:">
                        <img class="z-index-2" @if (isset($systemlogo)) src="{{ dynamicStorage('storage/app/public/business/' . $systemlogo->value) }}" @else src="{{dynamicAsset('/public/assets/admin/img/auth-fav.png')}}" @endif>
                    </a>
                    ...
                    <form action="{{ route('reset-password-submit') }}" method="POST">
                        ...
                        <div class="js-form-message form-group mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" class="js-toggle-password form-control form-control-lg" name="password" id="signupSrPassword" placeholder="{{translate('messages.password_length_8+')}}" aria-label="{{translate('messages.password_length_8+')}}" required data-msg="{{translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')}}" data-hs-toggle-password-options='{
                                                    "target": "#new-pass",
                        ...
                        <div class="js-form-message form-group mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" class="js-toggle-password form-control form-control-lg" name="confirm_password" id="signupSrPassword" placeholder="{{translate('messages.password_length_8+')}}" aria-label="{{translate('messages.password_length_8+')}}" required data-msg="{{translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')}}" data-hs-toggle-password-options='{
                                                    "target": "#conf-pass",
                                        "defaultClass": "tio-hidden-outlined",
                                        "showClass": "tio-visible-outlined",
