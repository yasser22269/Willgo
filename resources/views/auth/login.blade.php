...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.login') }} | {{$app_name??translate('Willgoapp')}}</title>
    ...
    <main id="content" role="main" class="main auth-bg">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            <div class="auth-content">
                <div class="content">
                    <h2 class="title text-uppercase">{{translate('messages.welcome_to')}} {{ $app_name??'Willgoapp' }}</h2>
                    <p>
            ...
            <div class="auth-wrapper">
                <div class="auth-wrapper-body auth-form-appear">
                    ...
                    <a class="auth-logo mb-5" href="javascript:">
                        <img class="z-index-2 onerror-image" src="{{ \App\CentralLogics\Helpers::get_full_url('business',$systemlogo?->value,$systemlogo?->storage[0]?->value ?? 'public', 'authfav') }}" data-onerror-image="{{ dynamicAsset('/public/assets/admin/img/auth-fav.png') }}" alt="image">
                    </a>
                    ...
                    <form class="login_form" action="{{route('login_post')}}" method="post" id="form-id">
                        ...
                        <div class="js-form-message form-group mb-2">
                            ...
                            <input type="email" class="form-control form-control-lg" value="{{ $email ?? '' }}" name="email" id="signinSrEmail" tabindex="1" aria-label="email@address.com" required data-msg="Please enter a valid email address.">
                        ...
                        <div class="js-form-message form-group">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" class="js-toggle-password form-control form-control-lg __rounded" name="password" id="signupSrPassword" value="{{ $password ?? '' }}" aria-label="{{translate('messages.password_length_placeholder',['length'=>'6+'])}}" required data-msg="{{translate('messages.invalid_password_warning')}}" data-hs-toggle-password-options='{
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="termsCheckbox" {{ $password ? 'checked' : '' }} name="remember">
                        ...
                        <div class="row p-2" id="reload-captcha">
                            <div class="col-6 pr-0">
                                <input type="text" class="form-control form-control-lg form-recapcha" name="custome_recaptcha" id="custome_recaptcha" required placeholder="{{translate('Enter_recaptcha_value')}}" autocomplete="off" value="{{env('APP_MODE')=='dev'? session('six_captcha'):''}}">
                            </div>
