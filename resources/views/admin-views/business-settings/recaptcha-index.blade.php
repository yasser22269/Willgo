                    ...
                    <form
                        ...
                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control mb-4">
                            ...
                            <input type="checkbox"
                                   ...
                                   data-type="toggle"
                                   data-image-on="{{ dynamicAsset('/public/assets/admin/img/modal/recapcha-on.png') }}"
                                   data-image-off="{{ dynamicAsset('/public/assets/admin/img/modal/recapcha-off.png') }}"
                                   data-title-on="{{ translate('Important!') }}"
                                   data-title-off="{{ translate('Warning!') }}"
                                   data-text-on="<p>{{ translate('reCAPTCHA_is_now_enabled_for_added_security._Users_may_be_prompted_to_complete_a_reCAPTCHA_challenge_to_verify_their_human_identity_and_protect_against_spam_and_malicious_activity.') }}</p>"
                                   data-text-off="<p>{{ translate('Disabling_reCAPTCHA_may_leave_your_website_vulnerable_to_spam_and_malicious_activity_and_suspects_that_a_user_may_be_a_bot._It_is_highly_recommended_to_keep_reCAPTCHA_enabled_to_ensure_the_security_and_integrity_of_your_website.') }}</p>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="secret_key" class="form-label">{{translate('messages.Secret Key')}}</label><br>
            ...
            <div class="modal-content {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                ...
                <div class="modal-body pb-0"><b></b>
                    <div class="text-center mb-20">
                        <img src="{{dynamicAsset('/public/assets/admin/img/modal/warning-recapcha-2.png')}}" alt="" class="mb-20">
