        ...
        <div class="card-body">
            <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                ...
                <label class="toggle-switch toggle-switch-sm">
                    <input type="checkbox" class="status toggle-switch-input landing-page" {{ isset($config) && $config ? 'checked' : '' }}>
                    ...
                    <div class="__input-tab {{  $landing_integration_type == 'url'?'active':''  }}" id="url">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-0 pb-2">
                                ...
                                <input type="url" placeholder="{{ translate('messages.Ex: https://Willgoapp-admin.willgoapp.site/') }}" class="form-control h--45px" name="redirect_url" value="{{ $redirect_url }}">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                                        ...
                                        <div class="uploadDnD">
                                            <div class="form-group mb-0 inputDnD bg-white rounded">
                                                <input type="file" name="file_upload" class="form-control-file text--primary font-weight-bold read-file" id="inputFile" accept=".zip" data-title="Drag & drop file or Browse file">
                                            </div>
                                        </div>
                            ...
                            <div class="col-6 col-md-4 col-xxl-3">
                                <div class="card theme-card">
                                    <div class="card-body d-flex justify-content-between">
                                        ...
                                        <a class="btn action-btn btn--danger btn-outline-danger border-0 form-alert" href="javascript:" data-id="index_page" data-message="{{ translate('Want to delete this index_page ?') }}" title="{{translate('messages.delete_index_page')}}"><i class="tio-delete-outlined"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="__input-tab {{ $landing_integration_type == 'none' ?'active':'' }}" id="none">
                        <div class="__bg-F8F9FC-card">
                            ...
                            <div class="text-center max-w-595 mx-auto py-4">
                                ...
                                <p class="m-0">
                                    {{ translate('Currently_you_are_using_Willgoapp_Default_Admin_Landing_Page_Theme.') }}
