                ...
                <div class="card-body">
                    <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                        ...
                        <label class="toggle-switch toggle-switch-sm">
                            ...
                            <input type="checkbox" class="status toggle-switch-input dynamic-checkbox" data-id="mail-status" data-type="status" data-image-on='{{dynamicAsset(' /public/assets/admin/img/modal')}}/place-order-on.png' data-image-off="{{dynamicAsset('/public/assets/admin/img/modal')}}/place-order-off.png" data-title-on="{{translate('Want_to_enable_advertisement_resume_mail?')}}" data-title-off="{{translate('Want_to_disable_advertisement_resume_mail?')}}" data-text-on="<p>{{translate('If_enabled,restaurants_will_receive_mail_on_advertisement_resume.')}}</p>" data-text-off="<p>{{translate('If_disabled,restaurants_won\'t_receive_a_mail_on_advertisement_resume.')}}</p>" id="mail-status" {{$mail_status=='1' ?'checked':''}}>
