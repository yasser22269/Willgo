        ...
        <tr>
            <td class="main-table-td">
                <div class="text-center">
                    <img class="mail-img-2 onerror-image" data-onerror-image="{{ dynamicAsset('/public/assets/admin/img/blank3.png') }}" src="{{ $data['icon_full_url'] ?? dynamicAsset('/public/assets/admin/img/blank1.png') }}" id="iconViewer" alt="">
