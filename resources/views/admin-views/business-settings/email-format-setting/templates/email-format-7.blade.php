    ...
    <tbody>
        <tr>
            ...
            <td class="main-table-td">
                <img class="mail-img-1 onerror-image" data-onerror-image="{{ dynamicAsset('/public/assets/admin/img/blank1.png') }}" src="{{ $data['logo_full_url'] ?? dynamicAsset('/public/assets/admin/img/blank1.png') }}" id="logoViewer" alt="">
                ...
                <img class="mb-2 mail-img-3 onerror-image" id="bannerViewer" data-onerror-image="{{ dynamicAsset('/public/assets/admin/img/blank2.png') }}" src="{{ $data['image_full_url'] ?? dynamicAsset('/public/assets/admin/img/blank1.png') }}" alt="">
                <hr>
