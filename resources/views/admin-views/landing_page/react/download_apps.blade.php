            ...
            <form action="{{ route('admin.react_landing_page.settings', 'react-download-apps-banner-image') }}" enctype="multipart/form-data" method="post">
                ...
                <div class="position-relative d-inline-block">
                    <label class="upload-img-3 upload-image-5 border--dashed border-1px m-0 rounded border-9EADC1">
                        <div class="img">
                            <img src="{{ Helpers::get_full_url('react_download_apps_image', $react_download_apps_banner_image?->value,$react_download_apps_banner_image?->storage[0]?->value ?? 'public','upload_image')}}" data-onerror-image="{{dynamicAsset('/public/assets/admin/img/upload.png')}}" class="onerror-image" alt="">
                        </div>
                        <input type="file" required name="react_download_apps_banner_image" hidden>
                    </label>
                    @if ($react_download_apps_banner_image?->value)
                    <span id="remove_image" class="remove_image_button remove-image" data-id="remove_image" data-title="{{translate('Warning!')}}" data-text="<p>{{translate('Are_you_sure_you_want_to_remove_this_image_?')}}</p>"> <i class="tio-clear"></i></span>
                    @endif
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="react_download_apps_tag" class="form-label">{{translate('Tag_line')}} ({{ translate('default') }})
                                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_Tagline_within_100_characters') }}">
                                            <i class="tio-info-outined"></i>
                                        </span>
                                    </label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="position-relative d-inline-block">
                            <label class="upload-img-3 m-0">
                                <div class="img">
                                    <img src="{{ Helpers::get_full_url('react_download_apps_image', $react_download_apps_image?->value,$react_download_apps_image?->storage[0]?->value ?? 'public','upload_1_1')}}" data-onerror-image="{{dynamicAsset('/public/assets/admin/img/upload-3.png')}}" class="vertical-img max-w-187px onerror-image" alt="">
                                </div>
                                <input type="file" name="react_download_apps_image" hidden>
                            </label>

                            @if ($react_download_apps_image?->value)
                            <span id="remove_image_1" class="remove_image_button remove-image" data-id="remove_image_1" data-title="{{translate('Warning!')}}" data-text="<p>{{translate('Are_you_sure_you_want_to_remove_this_image_?')}}</p>"> <i class="tio-clear"></i></span>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-6">
                        <h5 class="card-title mb-3">
                            <img src="http://localhost/Willgoapp/public/assets/admin/img/andriod.png" class="mr-2" alt="">
                            ...
                            <div class="form-group mb-md-0">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm m-0">
                                        <input type="checkbox" id="react_download_apps_button_status" data-id="react_download_apps_button_status" data-type="toggle" data-image-on="{{ dynamicAsset('/public/assets/admin/img/modal/play-store-on.png') }}" data-image-off="{{ dynamicAsset('/public/assets/admin/img/modal/play-store-off.png') }}" data-title-on="<strong>{{translate('Want_to_enable_the_Customer_App_Download_button_here')}}</strong>" data-title-off="<strong>{{translate('Want_to_disable_the_Customer_App_Download_button')}}</strong>" data-text-on="<p>{{translate('If_enabled,_everyone_can_see_the_button_on_the_landing_page')}}</p>" data-text-off="<p>{{translate('If_disabled,_it_will_be_hidden_from_the_landing_page')}}</p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle" name="react_download_apps_button_status" value="1" {{ $react_download_apps_button_status?->value ?? null == 1 ? 'checked': '' }}>
                    ...
                    <div class="col-md-6">
                        <h5 class="card-title mb-3">
                            <img src="http://localhost/Willgoapp/public/assets/admin/img/apple.png" class="mr-2" alt="">
                        ...
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm m-0">
                                        <input type="checkbox" id="react_download_apps_link_status" data-id="react_download_apps_link_status" data-type="toggle" data-image-on="{{ dynamicAsset('/public/assets/admin/img/modal/apple-on.png') }}" data-image-off="{{ dynamicAsset('/public/assets/admin/img/modal/apple-off.png') }}" data-title-on="<strong>{{translate('Want_to_enable_the_Customer_App_Download_button_here')}}</strong>" data-title-off="<strong>{{translate('Want_to_disable_the_Customer_App_Download_button')}}</strong>" data-text-on="<p>{{translate('If_enabled,_everyone_can_see_the_button_on_the_landing_page')}}</p>" data-text-off="<p>{{translate('If_disabled,_it_will_be_hidden_from_the_landing_page')}}</p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle" name="react_download_apps_link_status" value="1" {{ $react_download_apps_link_data['react_download_apps_link_status'] ?? null==1 ? 'checked' : '' }}>
                                        <span class="toggle-switch-label text mb-0">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                    </label>
