...
<div class="delivery-logs-area h-25 overflow-hidden scroll-bar">
    ...
    <div class="item pause-log-item">
        ...
        <div class="inner px-lg-4">
            ...
            @else
            <button data-toggle="tooltip" data-placement="top" title="{{ translate('resume_period_is_over')}} " class="btn btn-secondary border-0" disabled="disabled">{{ translate('Resume') }}</button>
            @endif
            </div>
        </div>
    </div>
