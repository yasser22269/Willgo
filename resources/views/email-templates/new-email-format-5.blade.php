    ...
    <table dir="{{ $site_direction }}" style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img class="mail-img-2" @if ($data['icon']) src="{{ dynamicStorage('storage/app/public/email_template/') }}/{{ $data['icon']??'' }}" @else src='{{ dynamicAsset(' /public/assets/admin/img/email-template-img.png') }}' @endif id="iconViewer" alt="">
