        ...
        <tbody>
            <tr>
                <td class="main-table-td">
                    <img class="mail-img-1" id="logoViewer" src="{{ $data['logo_full_url'] ?? dynamicAsset('/public/assets/admin/img/blank1.png') }}" alt="image">
                    ...
                    <img class="mb-2 mail-img-3" id="bannerViewer" src="{{ $data['image_full_url'] ?? dynamicAsset('/public/assets/admin/img/blank1.png') }}" alt="image">
            ...
            <tr>
                <td>
                    ...
                    <span class="copyright" id="mail-copyright">
                        {{ $copyright_text ?? translate('Copyright_2023_Willgoapp._All_right_reserved') }}
                    </span>
                </td>
            </tr>
        </tbody>
