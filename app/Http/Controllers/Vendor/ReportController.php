...
class ReportController extends Controller
{
    ...
    public function campaign_order_report(Request $request){
        ...
        return view('vendor-views.report.campaign_order-report', compact('orders','orders_list', 'campaign_id','from','to','total_orders','filter','customer','total_on_the_way_count','total_refunded_count','total_failed_count','total_progress_count','total_canceled_count','total_delivered_count'));
    }
