...
$config['db_name'] = 'kxbfzrbvse';
$config['db_user'] = 'kxbfzrbvse';
$config['db_password'] = 'G42tw5KtJB';
...
$config['http_host'] = 'phpstack-1301331-4741838.cloudwaysapps.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'phpstack-1301331-4741838.cloudwaysapps.com';
$config['https_path'] = '';
